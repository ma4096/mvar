...
\newcommand{\loadvariables}[2]{
	% if I eventually choose to delete this feature of precompilation/collection, as it may cause problems, just rename the backgroundloadvariables to loadvariables
